...
export const partition_8x8_cdf: readonly (readonly number[])[] = [
	[19132, 25510, 30392], // ctx 0
	[13928, 19855, 28540], // ctx 1
	[12522, 23679, 28629], // ctx 2
	[9896, 18783, 25853], // ctx 3
] as const;

export const partition_16x16_cdf = [
...
export const partition_32x32_cdf = [
...
export const partition_64x64_cdf = [
...
export const skip_cdf = [31671] as const;
export const y_mode_cdf = [
	15588, 17027, 19338, 20218, 20682, 21110, 21825, 23244, 24189, 28165, 29093,
	30466,
] as const;
export const uv_mode_cdf = [
...
export const tx_type_cdf = [6554, 13107, 19661, 26214] as const;
...
export const eob_extra_4x4_cdf = [
	// qctx = 0
	[
		// Y
		[[16961], [17223], [7621]],
...
export const eob_extra_8x8_cdf = [
	// qctx = 0
	[
		// Y
		[[20401], [17025], [12845], [12873], [14094]],
		// U/V
		[[20681], [20701], [15250], [15017], [14928]],
	],
	// qctx = 1
	[
		// Y
		[[20430], [20662], [15367], [16970], [14657]],
		// U/V
		[[22117], [22028], [18650], [16042], [15885]],
	],
	// qctx = 2
	[
		// Y
		[[19139], [21487], [18959], [20910], [19089]],
		// U/V
		[[20536], [20664], [20625], [19123], [14862]],
	],
	// qctx = 3
	[
		// Y
		[[20238], [21057], [19159], [22337], [20159]],
		// U/V
		[[20125], [20559], [21707], [22296], [17333]],
	],
] as const;

export const coeff_base_eob_cdf = [
	// qctx = 0
	[
		// 4x4
		[
...
export const dc_sign_cdf = [
	// qctx = 0
	[
		// Y
		[[128 * 125], [128 * 102], [128 * 147]],
		// U/V
		[[128 * 119], [128 * 101], [128 * 135]],
	],
	// qctx = 1
	[
		// Y
...
// Scan orders for coefficient traversal
export const SCAN_ORDER_4x4: readonly [number, number][] = [
	[0, 0],
	[0, 1],
	[1, 0],
	[2, 0],
...
export const SCAN_ORDER_8x8: readonly [number, number][] = [
	[0, 0],
	[0, 1],
	[1, 0],
	[2, 0],
...
// Neighbor offsets for coefficient significance context
export const SIG_REF_DIFF_OFFSET: readonly [number, number][] = [
	[0, 1],
	[1, 0],
	[1, 1],
	[0, 2],
...
// Magnitude reference offsets for coeff_br context
export const MAG_REF_OFFSET: readonly [number, number][] = [
	[0, 1],
	[1, 0],
	[1, 1],
] as const;

// AV1 spec Coeff_Base_Ctx_Offset for txClass=0 (DCT_DCT), TX_8X8
// Indexed by [min(row,4)][min(col,4)], values: 0=DC, 1=near-DC, 6=mid, 21=far
export const COEFF_BASE_CTX_OFFSET_8x8: readonly (readonly number[])[] = [
	[0, 1, 6, 6, 21],
	[1, 6, 6, 21, 21],
	[6, 6, 21, 21, 21],
	[6, 21, 21, 21, 21],
